...
const Navigation: React.FC<NavigationProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <>
      {/* Mobile Header Strip */}
      <div className="md:hidden bg-white/95 dark:bg-black/95 backdrop-blur-sm border-b border-amber-500/50 dark:border-amber-500/20 px-4 py-2 sticky top-0 z-50">
        <div className="flex items-center justify-between">
          {/* Theme Toggle */}
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-colors"
          ...
          {user ? (
            ...
            <button
              ...
              className="text-sm px-3 py-1 bg-amber-500 hover:bg-amber-600 text-white rounded-lg transition-colors"
            >
              Sign In
            </button>
          )}
      ...
      {/* Desktop Navigation */}
      <nav className="hidden md:flex items-center justify-between bg-white/95 dark:bg-black/95 backdrop-blur-sm border-b border-amber-500/50 dark:border-amber-500/20 px-6 py-4 sticky top-0 z-50">
      ...
      {/* Mobile Tab Bar */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-black/95 backdrop-blur-sm border-t border-amber-500/50 dark:border-amber-500/20 z-50">
