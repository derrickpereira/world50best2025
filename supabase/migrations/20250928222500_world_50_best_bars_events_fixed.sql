/*
  # World's 50 Best Bars 2025 Events Migration - FIXED VERSION
  ...
  Note: ON CONFLICT clauses removed to avoid constraint errors
*/
...
VALUES 
  ...
  (
    ...
    'Enjoy us for the ultimate Italian Takeover featuring the most renowned Italian bartenders! 5 champions, 5 delicious twists of the most iconic Italian Aperitivos.',
...
-- Clear existing news items (optional - remove if you want to keep them)
-- DELETE FROM news_items;

-- Insert updated news items for World's 50 Best Bars theme
...
-- Clear existing FAQ items (optional - remove if you want to keep them)
-- DELETE FROM faq_items;

-- Insert updated FAQ items for World's 50 Best Bars theme  
